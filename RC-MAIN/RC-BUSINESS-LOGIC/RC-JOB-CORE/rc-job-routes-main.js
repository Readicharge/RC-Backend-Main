...
const {rc_job_creater,rc_job_Installer_confirmator,get_job_By_customerId,get_specfic_job_id,cancelJobByInstaller} = require("./rc-job-core");
...
router.post('/c-i-j',cancelJobByInstaller)  // c-i-j ~ Cancel Job by Installer
