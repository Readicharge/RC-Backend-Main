...
const {createService} = require("../../../../RC-CORE/RC-CONFIG-CORE/controllers/RC-SERVICE/rc-service-controller");


const createServiceServer = async (req,res) =>
{
   const data = req.body;
   const response_from_core = await createService(data);
